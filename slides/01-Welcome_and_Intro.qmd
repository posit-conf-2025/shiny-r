...
`r bsicons::bs_icon("github")` &nbsp; &nbsp; [github.com/posit-conf-2025/shiny-r](https://github.com/posit-conf-2025/shiny-r)
...
We need some data that we will be able to interact with for our Shiny apps today. We've collected weather data from [Meteostat](https://www.meteostat.net/) for several airports around the US.
...
::: aside
See [here](https://posit-conf-2025.github.io/shiny-r/data/) for a full data dictionary and the [source code](https://github.com/posit-conf-2025/shiny-r/blob/main/data/raw_weather.R) for collecting these data.
:::
