...
:::: {.larger}
`r bsicons::bs_icon("easel")` &nbsp; &nbsp; [pos.it/shiny-r-intro-24](https://pos.it/shiny-r-25)

<br/>

`r bsicons::bs_icon("github")` &nbsp; &nbsp; [github.com/posit-conf-2024/shiny-r-intro](https://github.com/posit-conf-2025/shiny-r)
...
I've provided recent weather data from [Meteostat](https://www.meteostat.net/) for airports around the US.
...
::: aside
See [here](https://posit-conf-2024.github.io/shiny-r-intro/data/) for a full data dictionary and the [source code](https://github.com/posit-conf-2024/shiny-r-intro/blob/main/data/raw_weather.R) for collecting these data.
:::
