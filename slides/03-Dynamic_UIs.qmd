...
```{r}
#| eval: false
#| code-line-numbers: "|30|36-46|37-42|43-45"
#| file: ../demos/demo05.R
```
...
To explicitly control the dependencies of these reactive expressions we can modify them using `bindEvent()` to definie the dependencies explicitly.
...
Previously we had: `observeEvent()` / `eventReactive()` but these have been soft deprecated as of Shiny 1.6.

::: aside
*Note* - when binding a reactive we use the functional form, i.e. `obj()` and not `obj`
:::


## Modal dialogs

These are a popup window element that allow us to present important messages or other UI elements in a way that does not permanently clutter up the main UI of an app.

The modal dialog consists of a number of Shiny UI elements (static or dynamic) and only displays when it is triggered (usually by something like an action button or action link).
...
```{r}
#| eval: false
#| code-line-numbers: "|30|37-54|37,53,54|38,52|39-51|49,56-71|63-70"
#| file: ../demos/demo06.R
```
...
```{r}
#| eval: false
#| code-line-numbers: "|6|8,14-17|10,19-28"
library(tidyverse)
library(shiny)
library(bslib)
...
```{r}
#| eval: false
#| code-line-numbers: "|14-37|29-36|51-53"
#| file: ../demos/demo07.R
```
...
```{r}
#| eval: false
#| code-line-numbers: "|37|51-76|56,75|57-62|63-68|69-74"
#| file: ../demos/demo08.R
```
...
```{r}
#| eval: false
#| code-line-numbers: "|29-35|36|26,41,42"
#| file: ../demos/demo09.R
```
